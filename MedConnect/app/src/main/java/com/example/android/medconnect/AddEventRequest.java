...
public class AddEventRequest extends StringRequest {
    ...
    public AddEventRequest(String EventName, String Location, String Phone, String Email,String Times,String Price, String ID,Response.Listener<String> listener){
