...
public class EventsListDownloader extends AsyncTask<Void, Void, String> {
    ...
    //Constructor
    public EventsListDownloader(Context c, String urlAddress, ListView lv) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if (s == null) {
            ...
            EventsListParser parser = new EventsListParser(c, lv, s);
            parser.execute();
    ...
    private String downloadData() {
        ...
        HttpURLConnection con = EventsListConnector.connect(urlAddress);
        if (con == null) {
            return null;
        }
