    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent registerOrganizationIntent = new Intent(LoginOrganizationActivity.this, RegisterOrganizationActivity.class);
                LoginOrganizationActivity.this.startActivity(registerOrganizationIntent);
            }
        });
        ...
        */
        ...
        bLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LoginOrganizationRequest loginOrganizationRequest = new LoginOrganizationRequest(username, password, responseListener);
                RequestQueue queue = Volley.newRequestQueue(LoginOrganizationActivity.this);
                queue.add(loginOrganizationRequest);
