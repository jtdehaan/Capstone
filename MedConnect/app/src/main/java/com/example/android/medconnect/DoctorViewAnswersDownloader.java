...
public class DoctorViewAnswersDownloader extends AsyncTask<Void, Void, String> {
    ...
    //Constructor
    public DoctorViewAnswersDownloader(Context c, String urlAddress, ListView lv) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if (s == null) {
            ...
            DoctorViewAnswersParser parser = new DoctorViewAnswersParser(c, lv, s);
            parser.execute();
    ...
    private String downloadData() {
        ...
        HttpURLConnection con = DoctorViewAnswersConnector.connect(urlAddress);
        if (con == null) {
            return null;
        }
