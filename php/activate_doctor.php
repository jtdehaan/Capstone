<?php
    ...
    $sql = "SELECT * FROM LoginDoctor WHERE email_code = '$email_code'";
	...
	{
		mysqli_query($con, "UPDATE LoginDoctor SET email_code = '0'");
		mysqli_query($con, "UPDATE LoginDoctor SET active = 1");
