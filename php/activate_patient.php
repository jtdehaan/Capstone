<?php
    ...
    $sql = "SELECT * FROM LoginPatient WHERE email_code = '$email_code'";
	...
	{
		mysqli_query($con, "UPDATE LoginPatient SET email_code = '0'");
		mysqli_query($con, "UPDATE LoginPatient SET active = 1");
