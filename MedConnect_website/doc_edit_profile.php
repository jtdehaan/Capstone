...
$sql = "SELECT * FROM LoginDoctor WHERE username = '$session_user'";
...
$current_password_err = "Incorrect Password";
 //exicute
    if(empty($username_err) &&empty($current_password) &&  empty($email_err) && empty($name_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "UPDATE LoginDoctor SET name = ?, username = ?, email = ? WHERE username = '$session_user'";
...
<head>
    ...
    <title>MC Doctor Edit Account</title>
    <!--CSS style sheets -->
