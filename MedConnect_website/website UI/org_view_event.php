...
<head>
    ...
    <title>MC Organization View Events</title>
    <!--CSS style sheets -->
...
<body>
    <nav>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a class="selected" href="org_view_event.php">View My Events</a>
    ...
    <main>
        ...
        <div class="admin_patient">
            <div class="table">
                ...
                if($result = mysqli_query($link, $sql)){
                    if(mysqli_num_rows($result) > 0){
                		echo '<table><tr><th>Name</th><th>Location</th><th>Date</th><th>Time</th><th>Price</th><th>description</th><th>attendance</th></tr>';
                        while($row = mysqli_fetch_array($result)){
                			echo "<tr><td>".$row['name'] ."</td><td>". $row['location']."</td><td>". $row['date']."</td><td>". $row['time']."</td><td>". $row['price']."</td><td>". $row['description']."</td><td>". $row['attendance']."</td></tr>"; }
                		echo "</table>";
                	}
                	else{
                		echo "no result";
